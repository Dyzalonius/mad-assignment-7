...
public class EventAdapter extends RecyclerView.Adapter<MemberViewHolder> {

    private Context context;
    public List<Member> members;

    public EventAdapter(Context context, List<Member> members) {
    ...
    public MemberViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.cell_attendee, parent, false);
